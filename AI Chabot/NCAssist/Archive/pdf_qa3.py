...
async def on_chat_start():
    ...
    # elements = [
    # cl.Image(name="image1", display="inline", path="D:/hackathon/NC_HACKATHON/AI_Chabot/solution/NCAssist/robot.jpeg")
    # ]
    ...
    for pdf_file in pdf_files:
        ...
        msg = cl.Message(content=f"Processing `{pdf_file}`...")
        await msg.send()
        ...
        metadatas = [{"source": f"{i}-"+pdf_file} for i in range(len(texts))]
        ...
        msg.content = f"Processing `{pdf_file}` done. You can now ask questions!"
        await msg.update()
